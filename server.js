...
function hasPermission(user, required) {
  ...
  if (required === "/production-processing" && ["/production/pending-machine-processing", "/production/pending-printing", "/production-processing/master"].some((path) => list.includes(path))) {
    return true;
  }
