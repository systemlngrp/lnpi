  ...
  return (
    <div className="flex h-[calc(100vh-120px)] overflow-hidden gap-4">
      ...
      <div className="w-64 flex flex-col gap-2 shrink-0">
        <h2 className="text-lg font-black uppercase tracking-tighter text-black mb-2 px-2">MRR Approvals</h2>
        {stages.map((s) => (
          <button
            key={s.value}
            onClick={() => {
      ...
      {/* Center: List View */}
      <div className="flex-1 flex flex-col bg-white rounded border border-black overflow-hidden min-w-0">
