    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="bg-white border-2 border-black rounded shadow-sm overflow-hidden">
        <div className={`${style.tile} border-b-2 border-black px-5 py-5`}>
          ...
          <div className="mt-1 text-3xl font-black uppercase tracking-tight">{status}</div>
        </div>
        ...
        <div className="border-t-2 border-black p-5 space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded border-2 border-black bg-emerald-600 px-6 py-3 text-sm font-black uppercase text-white hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
