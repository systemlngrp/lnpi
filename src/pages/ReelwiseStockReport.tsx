  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3 rounded border-2 border-black bg-white p-3 shadow-sm">
        <div className="flex flex-col gap-2 border-b border-black pb-2 md:flex-row md:items-center md:justify-between">
          <h3 className="text-sm font-black uppercase text-black">Stock Taker Master</h3>
        ...
        <div className="grid gap-2 md:grid-cols-2 xl:grid-cols-[minmax(240px,1fr)_130px_130px_210px_auto] xl:items-center">
          <div className="relative w-full min-w-0">
            <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400" size={14} />
            <input
              type="text"
              ...
              placeholder="Search scan reel / MRR / ERP / supplier / status"
              className="h-[34px] w-full rounded border-2 border-black pl-8 pr-2 text-xs font-semibold focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
            />
          </div>
        ...
        <div className="max-h-[420px] overflow-auto rounded border-2 border-black">
          <table className="w-full min-w-max border-collapse">
            <thead className="sticky top-0 z-10">
              <tr className="bg-indigo-700 text-white">
            ...
            <tbody>
              {filteredScanLogs.length === 0 ? (
                <tr>
                  <td colSpan={9} className="border-2 border-black px-6 py-8 text-center font-medium text-black">No stock taker scans match the current filters.</td>
                </tr>
              ) : (
